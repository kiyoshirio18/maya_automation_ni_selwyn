...
DEFAULT_DDR_DIR = r"\\192.168.15.241\admin\ACTIVE\scperez\MAYA\DAILY DIGITAL REPORT\2026"
DEFAULT_MERGE_ACCOUNTS_DIR = r"\\192.168.15.241\admin\ACTIVE\scperez\MAYA\MERGED ACCOUNTS\2026"
...
with tab1:
    ...
    with st.form("ddr_form"):
        ...
        default_ddr_name = get_latest_ddr_file(DEFAULT_DDR_DIR) or f"MADRID_DIGITAL RESULT_{yesterday}.xlsx"
        ddr_server_name = st.text_input(
            "Digital Result Sheet file name/path",
            value=default_ddr_name,
...
with tab2:
    ...
    with st.form("outbox_form"):
        ...
        default_merge_filename = f"maya_merged_accounts_{yesterday_str}.xlsx"
